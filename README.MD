...
| `test_read`                                | Teste la lecture des données dans la table spécifiée.          | Intégration       |
...
| `test_read_from_products`                  | Teste la lecture des données dans la table `products`.          | Intégration       |
